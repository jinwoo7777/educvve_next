        ...
        <div className="row td_gap_y_40">
          ...
          >
            ...
            <div className="td_section_heading td_style_1">
              ...
              학년·목표·약점에 따라 설계된 8가지 코스 중 하나를 선택하면,
              세부 커리큘럼과 수업 후기를 바로 확인할 수 있습니다.
              </p>
            </div>
            ...
            <div className="row">
              <div className="col-sm-6">
                ...
                >
                  ...
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link href="/course-details">개념 완성반</Link>
                    </h2>
                ...
                >
                  ...
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link href="/course-details">내신 기출 심화반</Link>
                    </h2>
                    <Link href="/course-details" className="td_card_btn">
                      <svg
                        width="23"
              ...
              <div className="col-sm-6">
                ...
                >
                  ...
                  <div className="td_card_info">
                    <h2 className="td_card_title mb-0 td_fs_18 td_semibold td_white_color">
                      <Link href="/course-details">의·치·한 집중반</Link>
                    </h2>
                    <Link href="/course-details" className="td_card_btn">
                      <svg
                        width="23"
